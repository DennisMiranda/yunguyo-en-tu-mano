# Phase 10: Panel Admin - Usuarios

**Objetivo:** Gestión de administradores.

## Archivos a crear/modificar

### 1. `src/pages/admin/Usuarios.tsx` (nuevo)

Listado de administradores con email, role y acciones.
...
### 3. `e2e/admin-users.spec.ts` (nuevo)

Tests:

- Listado carga correctamente
- Página de usuarios es accesible
...
// Agregar ruta dentro del AdminLayout
...
1. `feat(admin-users): add user management` — Usuarios.tsx, App.tsx
2. `test(e2e): add admin users tests` — e2e/admin-users.spec.ts
3. `docs: add phase 10 plan` — docs/phases/phase-10-admin-users/plan.md
